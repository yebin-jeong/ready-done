      ...
      messages: [
        {
          ...
          [스타일별 본문 구조 가이드]
          1. tutorial: 개요 -> 준비물 -> 단계별 가이드(코드예시 포함) -> 요약 및 다음 학습 방향
          2. til: 오늘 배운 것 요약 -> 상세 내용(코드예시 포함) -> 어려웠던 점(겪은 문제와 해결 과정) -> 느낀 점
          3. troubleshooting: 문제 상황 -> 원인 분석 -> 해결 방법(코드예시 포함) -> 결론(배운 점과 예방법)`,
        },
        {
          role: "user",
